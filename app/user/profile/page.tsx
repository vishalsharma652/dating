            ...
            {(user.unique_id || user.id) && (() => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[11px] font-black text-[#10B981] tracking-widest uppercase">Your ID: {displayUniqueId}</span>
                  ...
                  <div className="mt-4 flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-[#10B981]/10 to-[#6366f1]/10 border border-[#10B981]/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-black text-white tracking-widest">{displayUniqueId}</p>
                      </div>
                    </div>
                    <button
                      type="button"
                      onClick={() => { navigator.clipboard.writeText(displayUniqueId); setMessage('Unique ID copied!'); setTimeout(() => setMessage(''), 2000); }}
