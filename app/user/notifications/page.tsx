        ...
        <div className="space-y-3">
          {notifications.map((notif) => {
            ...
            return (
              <Card
                key={notif.id}
                className={`p-4 cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition ${
                  !notif.read ? 'border-l-4 border-l-pink-500' : ''
                }`}
              >
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-1">
                      <h3 className={`font-semibold ${!notif.read ? 'text-pink-500' : ''}`}>
                        {notif.title}
                      </h3>
                      {!notif.read && (
