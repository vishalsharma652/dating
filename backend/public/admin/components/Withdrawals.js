    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', width: '100%' }}>
      ...
      <section className="panel" style={{ width: '100%', overflow: 'hidden' }}>
        <div className="panel-body" style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
          ...
          {/* ── Table Container (SMOOTH HORIZONTAL SCROLL) ─────────── */}
              ...
              <table style={{ width: '100%', minWidth: '920px', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ background: 'rgba(15, 23, 42, 0.6)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                    <th style={{ width: '120px', padding: '14px 16px' }}>Wallet ID</th>
                    <th style={{ minWidth: '180px', padding: '14px 16px' }}>User Details</th>
                    <th style={{ width: '110px', padding: '14px 16px' }}>Amount</th>
                    <th style={{ width: '100px', padding: '14px 16px' }}>Method</th>
                    <th style={{ minWidth: '220px', padding: '14px 16px' }}>Payout Account / Details</th>
